...
from p04bmiclass import fit_decision_tree, predict_decision_tree
...
## 3. 남이 만들어놓은 클래스 (DexisionTreeRegressor)를 이용한 머신러닝
# ---------------------------------------
# 2. 모델 리스트 정의
models = {
